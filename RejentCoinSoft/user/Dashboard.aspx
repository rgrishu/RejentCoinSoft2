<%@ Page Title="" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="admin_Dashboard" EnableSessionState="True"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        ...
        #ctl00_contentData_rbwallettype label {
            ...
            <div class="row">
                <div class="col-xl-5 box-col-12 des-xl-100">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                            <div class="card income-card card-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h5>
                                        <asp:Label ID="lblstakingwallet" runat="server" Text="0"></asp:Label></h5>
                                    <p>Staking Wallet</p>
                            ...
                            <div class="card income-card card-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h5>
                                        <asp:Label ID="lblewalletcoinbalance" runat="server" Text="0"></asp:Label></h5>
                                    <p>External Wallet(Coin)</p>
                                    <a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i class="toprightarrow-secondary fa fa-arrow-up me-2"></i>90.54% </a>
                                    <div class="parrten">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background: new 0 0 512 512;" xml:space="preserve">
                                            <g>
                        ...
                        <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec" id="divPremium" runat="server">
                            <div class="card income-card card-secondary">
                                <div class="card-body text-center">
                                    <div class="round-box">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background: new 0 0 512 512;" xml:space="preserve">
                                    ...
                                    <h5>
                                        <asp:Label ID="lblpremiumbalance" runat="server" Text="0"></asp:Label></h5>
                                    <p>Premium Wallet</p>
                                    <a class="btn-arrow arrow-secondary" href="javascript:void(0)"><i class="toprightarrow-secondary fa fa-arrow-up me-2"></i>90.54% </a>
                                    <div class="parrten">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 512 512" style="enable-background: new 0 0 512 512;" xml:space="preserve">
                                ...
                                <div class="card-body" style="padding-bottom: 5px; padding-top: 5px;">
                                    ...
                                    <div class="row">
                                        <div class="col text-center b-r-light" style="font-size: 13px;">
                                            <span>Balance</span>
                                            <h4>$
                                                    <span class="mb-0" style="font-size: 18px; font-weight: 600; color: black">
                                                        <asp:Label ID="lblbalanceamount2" runat="server" Text="0"></asp:Label></span>
                                            </h4>
                                        </div>
                                        <div class="col text-center" style="font-size: 13px;">
                                            ...
                                            <h4>$
                                                    <span class="mb-0" style="font-size: 18px; font-weight: 600; color: black">
                                                        <asp:Label ID="lblredeemedbalance" runat="server" Text="Label"></asp:Label></span></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body" style="padding-bottom: 5px; padding-top: 5px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col text-center" style="font-size: 14px;">
                                            <span>Redeem</span>
                                            <h4 class="mb-0">
                                                <asp:Label ID="lblredeemrtc" runat="server" Text="0"></asp:Label></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                        ...
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                ...
                                                <div class="media-body">
                                                    <span class="m-0">Direct Team</span>
                                                    <h4 class="mb-0 ">
                                                        <asp:Label ID="lbldirectteam" runat="server" Text="0"></asp:Label></h4>
                                        ...
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lbltotalteam" runat="server" Text="0"></asp:Label></h4>
                                        ...
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lblleftteam" runat="server" Text="0"></asp:Label></h4>
                                        ...
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lblrightteam" runat="server" Text="0"></asp:Label></h4>
                                ...
                                <div class="col-sm-6 col-xl-6 col-lg-6">
                                    <div class="card o-hidden border-0">
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                <div class="align-self-center text-center"><i class="fa fa-dollar  fa-3x"></i></div>
                                                <div class="media-body">
                                                    <span class="m-0">Direct Income</span>
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lbldirectincome" runat="server" Text="0"></asp:Label></h4>
                                    ...
                                    <div class="card o-hidden border-0">
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                <div class="align-self-center text-center"><i class="fa fa-dollar  fa-3x"></i></div>
                                                <div class="media-body">
                                                    <span class="m-0">Matching Bonus</span>
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lblmatchingincome" runat="server" Text="0"></asp:Label></h4>
                                                    <i class="icon-bg" data-feather="dollar-sign"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card o-hidden border-0">
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                <div class="align-self-center text-center"><i class="fa fa-dollar  fa-3x"></i></div>
                                                <div class="media-body">
                                                    <span class="m-0">Career Bonus</span>
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lblcareerbonus" runat="server" Text="0"></asp:Label></h4>
                                                    <i class="icon-bg" data-feather="dollar-sign"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card o-hidden border-0">
                                        <div class="bg-primary b-r-4 card-body">
                                            <div class="media static-top-widget">
                                                <div class="align-self-center text-center"><i class="fa fa-dollar  fa-3x"></i></div>
                                                <div class="media-body">
                                                    <span class="m-0">Staking Bonus</span>
                                                    <h4 class="mb-0">
                                                        <asp:Label ID="lblstakingbonus" runat="server" Text="0"></asp:Label></h4>
                                                    <i class="icon-bg" data-feather="dollar-sign"></i>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-header pt-4 pb-4">
                                    <div class="header-top text-center">
                                        ...
                                        <i class="fa fa-arrow-down" style="font-size: 22px; color: #1B4C43"></i>
                                    </div>
                                </div>
                                <div class="card-body   ">
                                    <div class="mb-3 text-center">
                                        <label>No of RTC</label>
                                        <asp:TextBox ID="txtdepositamount" onkeypress="return isNumber(event)" CssClass="form-control" runat="server"></asp:TextBox>

                                    </div>
                                    <div class="mb-3">
                                        <asp:Button ID="btnDeposit" OnClientClick="return validateDeposit();" OnClick="btnDeposit_Click" CssClass=" btn btn-success" runat="server" Text="Deposit" Style="width: 100%" />
                                    </div>
                                    <div class="">
                                        <asp:Button ID="btnDepositApprove" OnClick="btnDepositApprove_Click" CssClass=" btn btn-secondary" runat="server" Text="Approve" Style="width: 100%" />
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header pt-3 pb-0">
                                    <div class="header-top text-center">
                                        <h5 class="text-center pb-1">Withdrawal</h5>
                                        <i class="fa fa-arrow-up" style="font-size: 22px; color: #D22D3D;"></i>
                                    </div>
                                    <asp:Label ID="lblconversionrate" Visible="false" runat="server" Text="0"></asp:Label>
                                    <asp:Label ID="lblprevwithdrawlcoin" Visible="false" runat="server" Text="0"></asp:Label>
                                    <div class="row mb-2 text-center">
                                        <asp:RadioButtonList ID="rbwallettype" AutoPostBack="true" OnSelectedIndexChanged="rbwallettype_SelectedIndexChanged" RepeatDirection="Horizontal" runat="server">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 text-center">
                                        <label>
                                            <asp:Label ID="lblwithdrawaltext" runat="server" Text="Enter Amount($) or No of RTC"></asp:Label></label>
                                        <asp:TextBox ID="txtwithdrawal" onkeypress="return isNumber(event)" CssClass="form-control" runat="server"></asp:TextBox>

                                    </div>
                                    <div class="mb-3">
                                        <asp:Button ID="btnwithdrawal" OnClientClick="validateWithdrawal();" OnClick="btnwithdrawal_Click" CssClass=" btn btn-success" runat="server" Text="Withdrawal" Style="width: 100%" />
                                    </div>
                                    <div class="">
                                        <asp:Button ID="btnwithdrawalapprove" OnClick="btnwithdrawalapprove_Click" CssClass=" btn btn-secondary" runat="server" Text="Approve" Style="width: 100%" />
                                        <%--   <asp:Button ID="Button1" OnClick="Button1_Click" runat="server" Text="Button" />
                                        <asp:Label ID="lblreadfileresponse" runat="server" Text="Label"></asp:Label>--%>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-joins card widget-arrow">
                                <div class="row">
                                    <div class="col-sm-6 pe-0">
                                        <div class="media border-after-xs">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">Direct</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lbldirectbusiness" runat="server" Text="0"></asp:Label></span></h5>
                                    ...
                                    <div class="col-sm-6 ps-0">
                                        <div class="media">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">Sponser</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body ps-2">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lblsponserbusiness" runat="server" Text="0"></asp:Label></span></h5>
                                    ...
                                    <div class="col-sm-6 pe-0">
                                        <div class="media border-after-xs">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">Left</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lblleftbusiness" runat="server" Text="0"></asp:Label></span></h5>
                                                <%--<span class="mb-1">-$2658(36%)</span>--%>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 ps-0">
                                        <div class="media">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">Right</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body ps-2">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lblrightbusiness" runat="server" Text="0"></asp:Label></span></h5>
                                                <%--<span class="mb-1">+$369(15%)</span>--%>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 pe-0">
                                        <div class="media border-after-xs">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">My</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lblselfbusiness" runat="server" Text="0"></asp:Label></span></h5>
                                    ...
                                    <div class="col-sm-6 ps-0">
                                        <div class="media">
                                            <div class="align-self-center me-3 text-start">
                                                <span class="widget-t mb-1">Total</span>
                                                <h5 class="mb-0">Business</h5>
                                            </div>
                                            <div class="media-body align-self-center ps-3"><i class="font-primary" data-feather="arrow-up"></i></div>
                                            <div class="media-body ps-2">
                                                <h5 class="mb-0">$<span class="">
                                                    <asp:Label ID="lbltotalbusienss" runat="server" Text="0"></asp:Label></span></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script>
        ...
        function loaddashboard() {
            var cookiename = 'dashboardcokkie';
            var myCookie = getCookie2(cookiename)


            if (myCookie == null) {
                window.location.href = 'Dashboard.aspx';
                setCookie2(cookiename, cookiename, 1);
            }
        ...
        function setCookie2(cname, cvalue, exdays) {
            const d = new Date();
            d.setTime(d.getTime() + (exdays * 1 * 5 * 1 * 1000));
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row form-group">
                                <div class="col-md-4">Email OTP</div>
                                <div class="col-md-8">
                                    ...
                                    <asp:HiddenField ID="hdn_OTPEmail" runat="server" />
    ...
    <script type="text/javascript">
        function validateDeposit() {
            if (document.getElementById("<%=txtdepositamount.ClientID%>").value == "") {
                ...
                toastr.warning('Warning', 'Enter Deposit Amount');
                document.getElementById("<%=txtdepositamount.ClientID%>").focus();
                return false;
            }
        }
        function validateWithdrawal() {
            if (document.getElementById("<%=txtwithdrawal.ClientID%>").value == "") {

                toastr.warning('Warning', 'Enter Withdrawal Amount');
                document.getElementById("<%=txtwithdrawal.ClientID%>").focus();
                return false;
            }
        }
...
<asp:Content ID="Content5" ContentPlaceHolderID="Content4" runat="Server">
       <asp:UpdatePanel ID="vitalpopup" runat="server">
        <ContentTemplate>
            <div id="myModalRenew22" class="modal fade modal hide fade in" data-backdrop="static" data-keyboard="true" tabindex="-1" >
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        </div>
                        <div class="modal-body p-0">
                            <div class="form-group text-center">
                                <img src="img/popup2.jpg" alt="Vital Information" class="img-fluid">
                        ...
                        <div class="modal-footer">
                            <%--<asp:Button ID="btnopenRenew" runat="server" Text="Stake Now"  CssClass="btn btn-primary has-ripple" OnClientClick="return RedirectPage();" />--%>
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">I Accept</button>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function Showvitalpopup() {
            $('#myModalRenew22').modal('show');
