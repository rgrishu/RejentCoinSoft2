<%@ Page Title="Deposit(Smart Contract)" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="SmartContractDeposit.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
  <h4 class="page-title">Deposit(Smart Contract)</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Dashboard.aspx">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Deposit(Smart Contract)</li>
							</ol>
</asp:Content>
...
<%--                                       <asp:TemplateField HeaderText="From Address" ItemStyle-Width="190px">
                                    ...
                                    <asp:TemplateField HeaderText="ReferenceId">
                                        <ItemTemplate>
                                             <%--<div style="  white-space: nowrap;   width: 350px;   overflow: hidden;  text-overflow: ellipsis; ">--%>
