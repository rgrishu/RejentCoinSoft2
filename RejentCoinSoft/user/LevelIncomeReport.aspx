                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"
                               ...
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="From UserID">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("TopupUserID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                   <asp:TemplateField HeaderText="Junior Sponser Id">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("JuniorSponserId") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
