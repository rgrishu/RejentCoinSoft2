...
public partial class admin_Dashboard : System.Web.UI.Page
{
    ...
    void loaddashboard()
    {
        ...
        if (ds.Tables.Count > 0)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
               ...
               // lblewalletbalance.Text = ds.Tables[0].Rows[0]["ewalletbalance"].ToString();
                ...
                lblewalletcoinbalance.Text = ds.Tables[0].Rows[0]["ewalletcoinbalance"].ToString();
        ...
        //string popupScript2 = "Showvitalpopup();";
        //ScriptManager.RegisterStartupScript(vitalpopup, vitalpopup.GetType(), Guid.NewGuid().ToString(), popupScript2, true);
     ...
     protected void btnwithdrawal_Click(object sender, EventArgs e)
    {
        ...
        if (rbwallettype.SelectedValue.ToString() != "MWallet")
        {
                ...
                if (txtwithdrawal.Text != "")
                {
                    ...
                    if (Convert.ToDecimal(txtwithdrawal.Text) >= dcminlimint)
                    {
                        if (dcRemainingLimit >= 0)
                        {
                            ...
                            //  objuser.EmailBody = @"Dear User OTP is " + str_otpemail+" to Withdraw Amount "+ txtwithdrawal.Text +"Requested from IP Address " + objuser.IPAddress;
                            ...
                            if (dtbal.Rows[0]["SmartContractAddress"].ToString() != "")
                            {
                                ...
                                if (ds.Tables.Count > 0)
                                {
                                    if (ds.Tables[0].Columns.Contains("success"))
                                    {
                                        ...
                                        {
                                            string popupScript = "withdraw('" + txtwithdrawal.Text + "', '" + dtbal.Rows[0]["SmartContractAddress"].ToString() + "','" + rbwallettype.SelectedValue.ToString() + "','" + dtbal.Rows[0]["transactionid"].ToString() + "','" + "new" + "','"+ dtbal.Rows[0]["SmartContractAddress"].ToString() + "');";
                                            ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), popupScript, true);
