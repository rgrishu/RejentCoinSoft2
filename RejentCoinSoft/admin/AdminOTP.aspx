<%@ Page Language="C#" AutoEventWireup="true" Title="Login" CodeFile="AdminOTP.aspx.cs" Inherits="admin_index" %>
                                ...
                                <div class="login-card">
                                    <div class="theme-form login-form" style="text-align: center;">
                                        ...
                                        <h4 style="color:black;">Enter OTP</h4>
                                         <h6 runat="server" id="lbl_otp" >Enter OTP and set new password.</h6>
