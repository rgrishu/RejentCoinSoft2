<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="adminmaster.master" CodeFile="GoogleAuthenticatorSetup.aspx.cs" Inherits="GoogleAuthenticatorSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="Dashboard.aspx">2FA</a></li>
...
<asp:Content ID="contentDesc" ContentPlaceHolderID="contentData" runat="server">
    ...
    <div class="card" id="InsertOtpvalid" runat="server">
        <div class="card-header">
            <h5>OTP (Your otp is send on your Mobile.) </h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col">
