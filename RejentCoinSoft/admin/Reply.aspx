<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="Reply.aspx.cs" Inherits="admin_Reply" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentData" runat="Server">
        ...
        <div class="card">
            <div class="card-header bg-primary">
                <h5 class="mb-0 pl-0">
                    <a class="btn btn-link text-white collapsed" data-bs-toggle="collapse" data-bs-target="#collapseicon" aria-expanded="false" aria-controls="collapse11"><i class="fa fa-pencil"></i>Reply</a>
                </h5>
            </div>
                ...
                <ItemTemplate>
                    ...
                    <div class="card mt-3" style="background-color: <%#Eval("Background") %>;">
                        <div class="card-header">
