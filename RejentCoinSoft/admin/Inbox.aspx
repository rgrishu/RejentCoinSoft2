<%@ Page Title="Inbox" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="Inbox.aspx.cs" Inherits="admin_EPinAdd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
             <asp:Panel ID="pnllist" runat="server" Visible="false">
               <div class="card">
            <div class="card-header text-uppercase">Inbox
                            ...
                            <div class="col-lg-12 col-md-12">
                             <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False">
                                    ...
                                    <asp:TemplateField HeaderText="From">
                                        <ItemTemplate>
                                            <asp:Label ID="lblfromname"  runat="server" Text='<%# Eval("username") %>'></asp:Label>
