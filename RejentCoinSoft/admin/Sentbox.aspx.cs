...
public partial class admin_EPinAdd : System.Web.UI.Page
{
    ...
    private DataTable GetDataTable()
    {
        ...
        objsupport.FromId = Session["rijentadmin45852_4"].ToString();
    ...
    string setquery()
    {
        string s = "select * from SupportDetail where toid='" + Session["rijentadmin45852_4"].ToString() + "'";
        return s;
    ...
    protected void btnview_click(object sender, EventArgs e)
    {
        ...
        lblimage.Text = @"<a href='../admin/userimage/" + lblmessageimagename.Text + @"' target=""_blank""><img src='../admin/userimage/" + lblmessageimagename.Text + @"' /></a>";
