<%@ Page Title="Reward Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="RewardReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
  <h4 class="page-title">Reward Report</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Dashboard.aspx">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Reward Report</li>
							</ol>
</asp:Content>
                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Level">
                                        ...
                                        <asp:TemplateField HeaderText="Staking Amount($)">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("stackingamount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                    <asp:TemplateField HeaderText="Distribution Amount($)">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("distributionamount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>  
