<%@ Page Title="Direct Downline Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="DirectDownlineReport.aspx.cs" Inherits="admin_DownlineReport" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" PageSize="40" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true">
                         <Columns>
