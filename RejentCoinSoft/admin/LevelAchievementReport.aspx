<%@ Page Title="Level Achievement Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="LevelAchievementReport.aspx.cs" Inherits="admin_UserReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <h4 class="page-title">Level Income Report</h4>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Level Achievement Report</li>
							</ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ProgressTemplate>
         ...
         <div class="card">
                    <div class="card-header">
                        <h5>Level Achievement Report</h5>
                    </div>
                    <div class="card-body">

                        <div class="table-responsive">

                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" OnRowDataBound="GridView1_RowDataBound" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" PageSize="50" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="true" >
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Level">
                                        ...
                                        <asp:TemplateField HeaderText="Capping Times">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("capping") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
