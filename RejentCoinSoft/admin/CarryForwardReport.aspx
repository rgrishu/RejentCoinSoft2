<%@ Page Title="Carry Forward Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="CarryForwardReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
   <h4 class="page-title">Carry Forward Report</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Dashboard.aspx">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Carry Forward Report</li>
							</ol>
</asp:Content>
                               ...
                               <Columns>
                                  ...
                                  <%--  <asp:TemplateField HeaderText="User Name">
                                    ...
                                    <asp:TemplateField HeaderText="Standing Position">
                                        <ItemTemplate>
                                            <asp:Label ID="lblusername" runat="server" Text='<%#Eval("standingposition2") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
