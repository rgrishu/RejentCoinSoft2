<%@ Page Title="Transaction Report(EWallet)" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="TransactionReportEWallet.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
<h4 class="page-title">Transaction Report(External Wallet)</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Dashboard.aspx">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Transaction Report (External Wallet)</li>
							</ol>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">
    ...
    <div class="card">
               ...
               <div class="card">
                    <div class="card-header">
                        <h5>Transaction Report(External Wallet)</h5>
                    </div>
                    <div class="card-body">
