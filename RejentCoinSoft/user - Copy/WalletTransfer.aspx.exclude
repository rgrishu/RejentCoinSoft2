<%@ Page Title="Rejent Coin Wallet Transfer" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="WalletTransfer.aspx.cs" Inherits="admin_EPinAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
     <h4 class="page-title">Coin Wallet Transfer</h4>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Coin Wallet Transfer</li>
							</ol>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="card">
                <div class="card-header">
                    <h5>Rejent Coin Balance : <i class="fa fa-money"></i>
