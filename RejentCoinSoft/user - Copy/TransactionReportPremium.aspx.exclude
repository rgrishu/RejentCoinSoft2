<%@ Page Title="Premium Wallet History" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="TransactionReportPremium.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
  <h4 class="page-title">Premium Wallet History</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="Dashboard.aspx">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Premium Wallet History</li>
							</ol>
</asp:Content>
