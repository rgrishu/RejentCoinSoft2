...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
   <h4 class="page-title">Binary Income Report</h4>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Binary Income Report</li>
							</ol>
</asp:Content>
...
<div class="row">
 <div class="table-responsive">
                            ...
                            <asp:GridView ID="GridView1" runat="server" ShowFooter="true" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Transaction Id">
                                     ...
                                     <asp:TemplateField HeaderText="Left Business">
                                        <ItemTemplate>
                                            <asp:Label ID="lblleftbusness" runat="server" Text='<%#Eval("leftbusiness") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField> 
                                       <asp:TemplateField HeaderText="Right Business">
                                        <ItemTemplate>
                                            <asp:Label ID="lblrightbusiness" runat="server" Text='<%#Eval("RightBusiness") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField> 
